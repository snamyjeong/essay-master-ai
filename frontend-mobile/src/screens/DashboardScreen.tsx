...
export default function DashboardScreen() {
  ...
  // 임시 데이터 (추후 백엔드 연동)
  const userName = "정성남";
  const currentLevel = "Lv.5 메타인지 마스터"; // 백엔드 페르소나와 통일
    ...
    <SafeAreaView style={styles.safeArea}>
      <ScrollView style={styles.container}>
        ...
        <SoftCard style={styles.card}>
          ...
          {/* 에러를 유발하던 ProgressBar 대신 View로 안전하게 직접 구현 */}
...
const styles = StyleSheet.create({
  ...
  quickMenuContainer: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 5, paddingBottom: 30 },
